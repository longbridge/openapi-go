...
type GridTradeRule struct {
	...
	TriggerPriceType   TriggerPriceType // Trigger price type (Spread / Percent)
	...
	TimeInForce        GridTimeInForce  // Time in force (Day / GTC / GTD)
	...
	UpperLimitEvent    GridLimitEvent   // Action when the upper bound is reached
	LowerLimitEvent    GridLimitEvent   // Action when the lower bound is reached
