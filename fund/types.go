...
// FundFilters is the fund list filter options. Each list holds server-defined
// option objects preserved as raw JSON.
...
// server-defined structures preserved as raw JSON.
